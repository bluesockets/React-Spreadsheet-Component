    ...
    _createClass(SpreadsheetComponent, [{
        ...
        value: function render() {
            ...
            if (!data.rows && !config.rows) {
              ...
              headers.push(_react2.default.createElement(_row2.default, { cells: data.rows[0],
                cellClasses: _cellClasses && _cellClasses.rows && _cellClasses.rows[i] ? _cellClasses.rows[0] : null,
                uid: 0,
                key: 'row_0',
                config: config,
            ...
            // Create Rows
            for (i = 1; i < data.rows.length; i = i + 1) {
                key = 'row_' + i;
            ...
            let thead =  _react2.default.createElement("thead", null, headers)
            let tbody = _react2.default.createElement("tbody", null, rows)

            return _react2.default.createElement(
              "table",
              { tabIndex: "0", "data-spreasheet-id": this.state.id, ref: "react-spreadsheet-" + this.state.id },
              thead,
              tbody
            );
        }
